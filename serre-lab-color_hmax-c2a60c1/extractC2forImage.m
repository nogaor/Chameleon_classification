function mC2 = extractC2forImage(filters,fSiz,c1SpaceSS,c1ScaleSS,c1OL,cPatches,im,numPatchSizes,numSimpleFilters);
%
...
mC2 = [];
    ...
    for j = 1:numPatchSizes, %for every unique patch size
        ...
        if isempty(c1),  %compute C2
            [tmpC2,tmp1,c1] = C2(im,filters,fSiz,c1SpaceSS,c1ScaleSS,c1OL,cPatches{j});
        else
            [tmpC2] = C2(im,filters,fSiz,c1SpaceSS,c1ScaleSS,c1OL,cPatches{j},c1);
        end
        iC2 = [iC2;tmpC2];
    end
